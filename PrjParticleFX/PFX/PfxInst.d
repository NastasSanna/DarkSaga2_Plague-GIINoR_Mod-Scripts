...
instance WINDGOLEM_GLITTER(C_PARTICLEFX)
{
	ppsvalue = 20;
	ppsscalekeys_s = "2 1 1";
	ppsfps = 1;
	shptype_s = "SPHERE";//"SPHERE";
	shpfor_s = "object";
	shpoffsetvec_s = "0 0 0";
	shpdistribtype_s = "RAND";
	shpdim_s = "20";//"25";
	...
	visname_s = "FIRESMOKE.TGA";//"MFX_SLEEP_STAR.TGA";
	visorientation_s = "NONE";
	vistexisquadpoly = 1;
	vistexanifps = 5;
	vistexaniislooping = 1;
	...
	vistexcolorend_s = "255 255 255";
	vissizestart_s = "15 15";//"20 20";
	vissizeendscale = 1;
	visalphafunc_s = "ADD";
	visalphastart = 150;//255;
};
