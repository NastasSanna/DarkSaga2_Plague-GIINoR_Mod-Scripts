...
prototype SPELLFX_SUCKENERGY_BLOODFLY_PROTO(CFX_BASE)
{
	visalpha = 1;
	emtrjtargetrange = 10;
	emtrjtargetazi = 0;
...
instance SPELLFX_SUCKENERGY_BLOODFLY(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	visname_s = "MFX_SUCKENERGY_FLYTOPLAYER_L";
};

instance SPELLFX_SUCKENERGY_BLOODFLY_LEFTARM(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	emfxtriggerdelay = 1;
	emtrjoriginnode = "BIP01 L Hand";
	emtrjmode_s = "TARGET SPLINE RANDOM";
};
instance SPELLFX_SUCKENERGY_BLOODFLY_RIGHTARM(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	emfxtriggerdelay = 2;
	emtrjoriginnode = "BIP01 R Hand";
	emtrjmode_s = "TARGET SPLINE RANDOM";
};
instance SPELLFX_SUCKENERGY_BLOODFLY_LEFTUpperArm(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	emfxtriggerdelay = 1;
	emtrjoriginnode = "BIP01 L UpperArm";
	emtrjmode_s = "TARGET SPLINE RANDOM";
};
instance SPELLFX_SUCKENERGY_BLOODFLY_RIGHTUpperArm(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	emfxtriggerdelay = 2;
	emtrjoriginnode = "BIP01 R UpperArm";
	emtrjmode_s = "TARGET SPLINE RANDOM";
};
instance SPELLFX_SUCKENERGY_BLOODFLY_LEFTLEG(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	emfxtriggerdelay = 1;
	emtrjoriginnode = "BIP01 L Foot";
	emtrjmode_s = "TARGET SPLINE RANDOM";
};
instance SPELLFX_SUCKENERGY_BLOODFLY_RIGHTLEG(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	emfxtriggerdelay = 2;
	emtrjoriginnode = "BIP01 R Foot";
	emtrjmode_s = "TARGET SPLINE RANDOM";
};
instance SPELLFX_SUCKENERGY_BLOODFLY_HEAD(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	emfxtriggerdelay = 1;
	emtrjoriginnode = "BIP01 Head";
	emtrjmode_s = "TARGET SPLINE RANDOM";
};
instance SPELLFX_SUCKENERGY_BLOODFLY_SPINE(SPELLFX_SUCKENERGY_BLOODFLY_PROTO)
{
	emfxtriggerdelay = 2;
	emtrjoriginnode = "Bip01 Spine2";
	emtrjmode_s = "TARGET SPLINE RANDOM";
...
instance SPELLFX_FIRESTORM_SPREAD(CFX_BASE_PROTO)
{
	...
	emactioncollstat_s = "CREATE CREATEQUAD";
	emactioncolldyn_s = "CREATEONCE";
	emfxcollstat_s = "spellFX_Firestorm_COLLIDE";
	emfxcolldyn_s = "spellFX_ChargeFireball_COLLIDEDYNFX";
	emfxcolldynperc_s = "vob_magicburn";
