...
const int CTRL_Y_STEP = 290;
const int CTRL_Y_STEP2 = 180;
const int CTRL_Y_TITLE = 500;
const int CTRL_Y_START = 1020;
const int CTRL_GROUP1 = 0;
const int CTRL_GROUP2 = 160;
const int CTRL_GROUP3 = 320;
const int CTRL_GROUP4 = 480;
const int CTRL_GROUP5 = 640;
const int CTRL_GROUP6 = 800;
