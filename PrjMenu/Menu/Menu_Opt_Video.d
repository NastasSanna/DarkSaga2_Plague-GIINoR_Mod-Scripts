...
instance MENU_OPT_VIDEO(C_MENU_DEF)
{
	...
	items[11] = "MENUITEM_VID_ANISOTROPICFILTERING";
	items[12] = "MENUITEM_VID_ANISOTROPICFILTERING_CHOICE";
	items[13] = "MENUITEM_VID_ANTIALIASING";
	items[14] = "MENUITEM_VID_ANTIALIASING_CHOICE";
...
instance MENUITEM_VID_DEVICE(C_MENU_ITEM_DEF)
{
	...
	posx = 1000;
	posy = MENU_START_Y + (MENU_DS_DY * 0);
	dimx = 3000;
	dimy = 600;
...
instance MENUITEM_VID_DEVICE_CHOICE(C_MENU_ITEM_DEF)
{
	...
	posx = 3700;
	posy = MENU_START_Y + (MENU_DS_DY * 0) + MENU_CHOICE_YPLUS;
	dimx = 3700;
	dimy = MENU_CHOICE_DY;
...
instance MENUITEM_VID_RESOLUTION(C_MENU_ITEM_DEF)
{
	...
	posx = 1000;
	posy = MENU_START_Y + (MENU_DS_DY * 1);
	dimx = 2700;
	dimy = 600;
	onselaction[0] = SEL_ACTION_UNDEF;
...
instance MENUITEM_VID_RESOLUTION_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontname = MENU_FONT_SMALL;
	posx = 3700;
	posy = MENU_START_Y + (MENU_DS_DY * 1) + MENU_CHOICE_YPLUS;
	dimx = 3700;
	dimy = MENU_CHOICE_DY;
...
instance MENUITEM_VID_BRIGHTNESS(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Яркость";
	posx = 1000;
	posy = MENU_START_Y + (MENU_DS_DY * 3);
	dimx = 2700;
	dimy = 600;
	onselaction[0] = SEL_ACTION_UNDEF;
	flags = flags | IT_EFFECTS_NEXT;
...
instance MENUITEM_VID_BRIGHTNESS_SLIDER(C_MENU_ITEM_DEF)
{
	...
	posx = 3700;
	posy = MENU_START_Y + (MENU_DS_DY * 3) + MENU_SLIDER_YPLUS;
	dimx = MENU_SLIDER_DX;
	dimy = MENU_SLIDER_DY;
...
instance MENUITEM_VID_CONTRAST(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Контраст";
	posx = 1000;
	posy = MENU_START_Y + (MENU_DS_DY * 4);
	dimx = 2700;
	dimy = 600;
	onselaction[0] = SEL_ACTION_UNDEF;
	flags = flags | IT_EFFECTS_NEXT;
...
instance MENUITEM_VID_CONTRAST_SLIDER(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_SLIDER;
	posx = 3700;
	posy = MENU_START_Y + (MENU_DS_DY * 4) + MENU_SLIDER_YPLUS;
	dimx = MENU_SLIDER_DX;
	dimy = MENU_SLIDER_DY;
...
instance MENUITEM_VID_GAMMA(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Гамма";
	posx = 1000;
	posy = MENU_START_Y + (MENU_DS_DY * 5);
	dimx = 2700;
	dimy = 600;
	onselaction[0] = SEL_ACTION_UNDEF;
	flags = flags | IT_EFFECTS_NEXT;
...
instance MENUITEM_VID_GAMMA_SLIDER(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_SLIDER;
	posx = 3700;
	posy = MENU_START_Y + (MENU_DS_DY * 5) + MENU_SLIDER_YPLUS;
	dimx = MENU_SLIDER_DX;
	dimy = MENU_SLIDER_DY;
...
instance MENUITEM_VID_ANISOTROPICFILTERING(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Анизотропия";
	text[1] = "Для вступления в силу, необходимо перезапустить игру.";
	posx = 1000;
	posy = MENU_START_Y + (MENU_DS_DY * 6);
	dimx = 3000;
	dimy = 600;
	onselaction[0] = SEL_ACTION_UNDEF;
	flags = flags | IT_EFFECTS_NEXT;
...
instance MENUITEM_VID_ANISOTROPICFILTERING_CHOICE(C_MENU_ITEM_DEF)
{
	text[0] = "выкл|вкл";
	backpic = MENU_CHOICE_BACK_PIC;
	type = MENU_ITEM_CHOICEBOX;
	fontname = MENU_FONT_SMALL;
	posx = 3700;
	posy = MENU_START_Y + (MENU_DS_DY * 6) + MENU_CHOICE_YPLUS;
	dimx = 3700;
	dimy = MENU_CHOICE_DY;
	onchgsetoption = "zTexAnisotropicFiltering";
	onchgsetoptionsection = "ENGINE";
	flags = flags & ~IT_SELECTABLE;
	flags = flags | IT_TXT_CENTER | IT_NEEDS_RESTART;
};

instance MENUITEM_VID_ANTIALIASING(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Сглаживание";
	text[1] = "Для вступления в силу, необходимо перезапустить игру.";
	posx = 1000;
	posy = MENU_START_Y + (MENU_DS_DY * 7);
	dimx = 3000;
	dimy = 600;
	onselaction[0] = SEL_ACTION_UNDEF;
	flags = flags | IT_EFFECTS_NEXT;
...
instance MENUITEM_VID_ANTIALIASING_CHOICE(C_MENU_ITEM_DEF)
{
	text[0] = "выкл|вкл";
	backpic = MENU_CHOICE_BACK_PIC;
	type = MENU_ITEM_CHOICEBOX;
	fontname = MENU_FONT_SMALL;
	posx = 3700;
	posy = MENU_START_Y + (MENU_DS_DY * 7) + MENU_CHOICE_YPLUS;
	dimx = 3700;
	dimy = MENU_CHOICE_DY;
	onchgsetoption = "zVidEnableAntiAliasing";
	onchgsetoptionsection = "ENGINE";
	flags = flags & ~IT_SELECTABLE;
	flags = flags | IT_TXT_CENTER | IT_NEEDS_RESTART;
};
