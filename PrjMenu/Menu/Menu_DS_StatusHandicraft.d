...
*/
instance MENU_ITEM_SWITCH_BATTLE(C_MENU_ITEM_DEF)
{
	posx = STAT_A_X1;
	...
	//oneventaction[1] = Update_game;
	onselaction[0] = SEL_ACTION_BACK;
	//onselaction[0] = SEL_ACTION_STARTMENU;
	//onselaction_s[0] = "MENU_DSSTATUS_HANDICRAFT";	
	//flags = flags | IT_EFFECTS_NEXT;
};/*
instance MENU_ITEM_SWITCH_BATTLE_CHOICE(C_MENU_ITEM_DEF)
{
...
{posx = STAT_A_X1;posy = STAT_PLYHEAD_Y;dimx = STAT_A_X4 - STAT_A_X1;dimy = STAT_DY;text[0] = "Аластер";fontname = STAT_FONT_SAGA_20;flags = (flags & ~IT_SELECTABLE) | IT_TXT_CENTER;};
...
{posx = STAT_A_X2;posy = STAT_PLY_Y + STAT_DY*0;text[0] = "Уров.";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_PLY_Y + STAT_DY*2;text[0] = "Опыт";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_PLY_Y + STAT_DY*3;text[0] = "След. уровень";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_PLY_Y + STAT_DY*4;text[0] = "Ед. опыта";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_ATRHEAD_Y;dimx = STAT_A_X4 - STAT_A_X1;dimy = STAT_DY;text[0] = "ХАРАКТЕРИСТИКИ";text[1] = "ХАРАКТЕРИСТИКИ";fontname = STAT_FONT_SAGA_20;flags = (flags & ~IT_SELECTABLE) | IT_TXT_CENTER;};
instance MENU_ITEM_ATTRIBUTE_1_TITLE(C_MENU_ITEM_DEF)
{posx = STAT_A_X1;posy = STAT_ATR_Y + STAT_DY*0;text[0] = "Сила";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_ATR_Y + STAT_DY*1;text[0] = "Ловкость";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_ATR_Y + STAT_DY*2;text[0] = "Мана";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_ATR_Y + STAT_DY*3;text[0] = "Очки жизни";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_ARMHEAD_Y;dimx = STAT_A_X4 - STAT_A_X1;dimy = STAT_DY;text[0] = "ЗАЩИТА";text[1] = "ЗАЩИТА";fontname = STAT_FONT_SAGA_20;flags = (flags & ~IT_SELECTABLE) | IT_TXT_CENTER;};
instance MENU_ITEM_ARMOR_1_TITLE(C_MENU_ITEM_DEF)
{posx = STAT_A_X1;posy = STAT_ARM_Y + STAT_DY*0;text[0] = "от Оружия";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_ARM_Y + STAT_DY*1;text[0] = "от Стрел";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_ARM_Y + STAT_DY*2;text[0] = "от Огня Дракона";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
{posx = STAT_A_X1;posy = STAT_ARM_Y + STAT_DY*3;text[0] = "от Магии";fontname = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE;};
...
instance MENU_ITEM_TALENTS_HEADING(C_MENU_ITEM_DEF)
{posx = STAT_A_X1;posy = STAT_TALHEAD_Y + STAT_ARMHEAD_Y + 600;dimx = STAT_A_X4 - STAT_A_X1;dimy = STAT_DY;text[0] = "НАВЫКИ";fontname = STAT_FONT_SAGA_20;flags = (flags & ~IT_SELECTABLE) | IT_TXT_CENTER;};
/*
...
//INSTANCE MENU_ITEM_TALENT_17_1(C_MENU_ITEM_DEF)	   {posx = STAT_B_X1;posy = STAT_TAL_Y + 13*STAT_DY;fontName = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE; text[0] = "ЯЗЫКИ";};
...
//INSTANCE MENU_ITEM_TALENT_16_1(C_MENU_ITEM_DEF)	   {posx = STAT_B_X1;posy = STAT_TAL_Y + 17*STAT_DY;fontName = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE; text[0] = "ТРОФЕИ";};
//INSTANCE MENU_ITEM_TALENT_16_2(C_MENU_ITEM_DEF)	   {posx = STAT_B_X1;posy = STAT_TAL_Y + 18*STAT_DY;fontName = STAT_FONT_SAGA_20;flags = flags & ~IT_SELECTABLE; text[0] = "ЖИВОТНЫХ:";};
...
instance MENU_ITEM_TALENT_19(C_MENU_ITEM_DEF)
{posx = STAT_B_X2;posy = STAT_TAL_Y + 18*STAT_DY;fontname = STAT_FONT_DEFAULT;flags = flags & ~IT_SELECTABLE; 
	//hideifoptionsectionset = "DARKSAGA";
	//hideifoptionset = "showBattleCraft";
	//hideonvalue = 1;
...
*/
instance MENU_DSSTATUS_HANDICRAFT(C_MENU_DEF)
{
	...
	items[32] = "MENU_ITEM_TALENTS_HEADING";
	items[33] = "MENU_ITEM_SWITCH_BATTLE";
/*	items[34] = "MENU_ITEM_SWITCH_BATTLE_CHOICE";*/
	items[34] = "MENU_ITEM_TALENT_19_TITLE";
	items[35] = "MENU_ITEM_TALENT_19_SKILL";
/*	items[37] = "MENU_ITEM_TALENT_1_TITLE";
	...
	items[36] = "MENU_ITEM_TALENT_8_TITLE";
	items[37] = "MENU_ITEM_TALENT_8_SKILL";
	items[38] = "MENU_ITEM_TALENT_5_TITLE";
	items[39] = "MENU_ITEM_TALENT_5_SKILL";
