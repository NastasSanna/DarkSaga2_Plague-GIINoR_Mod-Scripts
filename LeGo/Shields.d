...
const string Shield_SlotEquip = "ZS_SHIELD"; // Wohin wenn das Schild equipped wird?
const string Shield_SlotDrawn = "ZS_LEFTARM";  // Wohin wenn das Schild gezogen wird?
//const int    Shield_Slot      = 4;              // Genutzter Model-Slot
const int    Shield_Slot      = 5;
...
func void _EVT_Shield_Equip() {
	...
	if(!shieldPtr) { return; };
	var c_item shield; shield = _^(shieldPtr);
...
func void _Shield_Draw(var c_npc slf) {
	...
	var c_item shield; shield = _^(slf.aivar[Shield_AIVar1]);
