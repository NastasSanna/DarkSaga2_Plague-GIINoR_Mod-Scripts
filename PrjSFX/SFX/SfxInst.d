...
instance SWORD_IN_STONE(C_SFX_DEF)
{
	file = "Sword_in_Stone.wav";
	vol = 55;
};
...
instance BABESIGH1(C_SFX_DEF)
{
	file = "BAB_Ambient01.wav";
	vol = 90;
};
instance BABESIGH2(C_SFX_DEF)
{
	file = "BAB_Ambient02.wav";
	vol = 90;
};

instance BABECRY(C_SFX_DEF)
{
...
instance ORC_AMBIENT(C_SFX_DEF)		{	file = "ORC_Ambient01.wav";	vol = 80;};
instance ORC_AMBIENT_A1(C_SFX_DEF){	file = "ORC_Ambient02.wav";	vol = 80;};
instance ORC_AMBIENT_A2(C_SFX_DEF){	file = "ORC_Ambient03.wav";	vol = 80;};
instance ORC_AMBIENT_A3(C_SFX_DEF){	file = "ORC_Ambient04.wav";	vol = 80;};
...
instance ORC_AMBIENTX(C_SFX_DEF)		{	file = "ORC_Ambient01.wav";	vol = 180;};
instance ORC_AMBIENTX_A1(C_SFX_DEF){	file = "ORC_Ambient02.wav";	vol = 180;};
instance ORC_AMBIENTX_A2(C_SFX_DEF){	file = "ORC_Ambient03.wav";	vol = 180;};
instance ORC_AMBIENTX_A3(C_SFX_DEF){	file = "ORC_Ambient04.wav";	vol = 180;};
...
instance LAUGH_DRAKS(C_SFX_DEF)
{
	file = "Laugh_Draks.wav";
	vol = 130;	
};
instance LAUGH_VISP(C_SFX_DEF)
{
	file = "Laugh_Visp.wav";
	vol = 130;	
};
instance LAUGH_BORIS(C_SFX_DEF)
{
	file = "laugh_boris.wav";
	vol = 130;	
};

instance LAUGH_KARER(C_SFX_DEF)
{
	file = "laugh_karer.wav";
	vol = 130;	
};
instance DIGGER_1(C_SFX_DEF)
{
	file = "Digg1.wav";
	vol = 100;	
};
instance DIGGER_2(C_SFX_DEF)
{
	file = "Digg2.wav";
	vol = 100;	
};
instance DIA_EXITCAMPHUNTER2_FirstWarn_18_01(C_SFX_DEF)
{
	file = "DIA_EXITCAMPHUNTER2_FirstWarn_18_01.wav";
	vol = 120;
};
instance ZMB_EAAAT1(C_SFX_DEF)
{
	file = "Eaaat1.wav";
	vol = 120;
};
instance ZMB_EAAAT2(C_SFX_DEF)
{
	file = "Eaaat2.wav";
	vol = 120;
};
instance ZMB_EAAAT3(C_SFX_DEF)
{
	file = "Eaaat3.wav";
	vol = 120;
};
instance ZMB_EAAAT4(C_SFX_DEF)
{
	file = "Eaaat4.wav";
	vol = 120;
};
instance ZMB_EAAAT5(C_SFX_DEF)
{
	file = "Eaaat5.wav";
	vol = 120;
};
instance ZMB_EAAAT6(C_SFX_DEF)
{
	file = "Eaaat6.wav";
	vol = 120;
};
instance VZRIV_BOCHEK(C_SFX_DEF)
{
	file = "VZRIV_BOCHEK.wav";
	vol = 127;
};
instance VISTREL(C_SFX_DEF)
{
	file = "VISTREL.wav";
	vol = 127;
};
