...
const int Value_Sc_PalLight = 50*Sc_DS_Kosten;
const int Value_Sc_PalLightHeal = 100*Sc_DS_Kosten;
const int Value_Sc_PalHolyBolt = 200*Sc_DS_Kosten;
const int Value_Sc_PalMediumHeal = 400*Sc_DS_Kosten;
const int Value_Sc_PalRepelEvil = 600*Sc_DS_Kosten;
const int Value_Sc_PalFullHeal = 800*Sc_DS_Kosten;
const int Value_Sc_PalDestroyEvil = 1000*Sc_DS_Kosten;
const int Value_Sc_Light = 10*Sc_DS_Kosten;
const int Value_Sc_Firebolt = 25*Sc_DS_Kosten;
const int Value_Sc_Charm = 100*Sc_DS_Kosten;
const int Value_Sc_Icebolt = 25*Sc_DS_Kosten;
const int Value_Sc_LightHeal = 25*Sc_DS_Kosten;
const int Value_Sc_SumGobSkel = 75*Sc_DS_Kosten;
const int Value_Sc_InstantFireball = 50*Sc_DS_Kosten;
const int Value_Sc_Zap = 60*Sc_DS_Kosten;
const int Value_Sc_SumWolf = 75*Sc_DS_Kosten;
const int Value_Sc_Windfist = 60*Sc_DS_Kosten;
const int Value_Sc_Sleep = 100*Sc_DS_Kosten;
const int Value_Sc_MediumHeal = 60*Sc_DS_Kosten;
const int Value_Sc_LightningFlash = 125*Sc_DS_Kosten;
const int Value_Sc_ChargeFireball = 60*Sc_DS_Kosten;
const int Value_Sc_SumSkel = 75*Sc_DS_Kosten;
const int Value_Sc_Fear = 75*Sc_DS_Kosten;
const int Value_Sc_IceCube = 100*Sc_DS_Kosten;
const int Value_Sc_ThunderBall = 75*Sc_DS_Kosten;
const int Value_Sc_SumGol = 150*Sc_DS_Kosten;
const int Value_Sc_HarmUndead = 75*Sc_DS_Kosten;
const int Value_Sc_Pyrokinesis = 150*Sc_DS_Kosten;
const int Value_Sc_Firestorm = 100*Sc_DS_Kosten;
const int Value_Sc_IceWave = 200*Sc_DS_Kosten;
const int Value_Sc_SumDemon = 200*Sc_DS_Kosten;
const int Value_Sc_FullHeal = 200*Sc_DS_Kosten;
const int Value_Sc_Firerain = 250*Sc_DS_Kosten;
const int Value_Sc_BreathOfDeath = 250*Sc_DS_Kosten;
const int Value_Sc_MassDeath = 250*Sc_DS_Kosten;
const int Value_Sc_ArmyOfDarkness = 250*Sc_DS_Kosten;
const int Value_Sc_Shrink = 250*Sc_DS_Kosten;
...
instance ItSc_SoulTravel(C_Item)	//UNFINISHED
{
	name = NAME_Spruchrolle;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
	...
	visual = "ItSc_Shrink.3DS";
	material = MAT_LEATHER;
	spell = SPL_SoulTravel;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER";
	description = NAME_SPL_SoulTravel;
	text[0] = NAME_MageScroll;
