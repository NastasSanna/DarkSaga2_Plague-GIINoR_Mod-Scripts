...
class C_SVM
{
	...
	var string Smalltalk41;
	var string Smalltalk42;
	var string Smalltalk43;
...
instance SVM_3(C_SVM)
{
	...
	ITookYourOre = "SVM_3_ITookYourOre";	//В любом случае эта руда тебе больше не пригодится!
	ShitNoOre = "SVM_3_ShitNoOre";	//У тебя совсем нет руды?! Неудачный день, приятель.	
...
instance SVM_4(C_SVM)
{
	...
	ITookYourOre = "SVM_4_ITookYourOre";	//Я просто возьму у тебя немного руды.
	ShitNoOre = "SVM_4_ShitNoOre";	//Нет руды? Хреново, парень, совсем хреново.
...
instance SVM_5(C_SVM)
{
	...
	ITookYourOre = "SVM_5_ITookYourOre";	//Не волнуйся, когда с тобой будет покончено, я позабочусь о твоей руде.
	ShitNoOre = "SVM_5_ShitNoOre";	//Нет даже дрянного куска руды!
...
instance SVM_6(C_SVM)
{
	...
	ITookYourOre = "SVM_6_ITookYourOre";	//Я постараюсь с пользой потратить твою руду.
	ShitNoOre = "SVM_6_ShitNoOre";	//Неудачно, руды нет!
...
instance SVM_7(C_SVM)
{
	...
	ITookYourOre = "SVM_7_ITookYourOre";	//Спасибо за руду, я выпью за твое здоровье!
	ShitNoOre = "SVM_7_ShitNoOre";	//Черт, у него даже нет руды!
...
instance SVM_8(C_SVM)
{
	...
	ITookYourOre = "SVM_8_ITookYourOre";	//Конечно, я бы предпочел убить тебя, но руда - это тоже неплохо.
	ShitNoOre = "SVM_8_ShitNoOre";	//Нет руды?! Ты - жалкий бесполезный ублюдок!
...
instance SVM_9(C_SVM)
{
	...
	ITookYourOre = "SVM_9_ITookYourOre";	//Похоже, ты еще не заплатил мне пошлину!
	ShitNoOre = "SVM_9_ShitNoOre";	//Разумеется, у такого неудачника просто не может быть руды!
...
instance SVM_10(C_SVM)
{
	...
	ITookYourOre = "SVM_10_ITookYourOre";	//Руда! Ну, это лучше, чем ничего!
	ShitNoOre = "SVM_10_ShitNoOre";	//У него даже нет руды!
...
instance SVM_11(C_SVM)
{
	...
	ITookYourOre = "SVM_11_ITookYourOre";	//Я возьму у тебя немного руды.
	ShitNoOre = "SVM_11_ShitNoOre";	//Руды нет! Вот черт!
...
instance SVM_12(C_SVM)
{
	...
	ITookYourOre = "SVM_12_ITookYourOre";	//Спасибо за то, что оставил мне немного руды!
	ShitNoOre = "SVM_12_ShitNoOre";	//Ничего! Руды нет.
...
instance SVM_13(C_SVM)
{
	...
	ITookYourOre = "SVM_13_ITookYourOre";	//Я постараюсь с пользой потратить твою руду!
	ShitNoOre = "SVM_13_ShitNoOre";	//Проклятье, руды нет!
...
instance SVM_14(C_SVM)
{
	...
	ITookYourOre = "SVM_14_ITookYourOre";	//Я думаю, ты не будешь возражать, если я возьму немного руды!
	ShitNoOre = "SVM_14_ShitNoOre";	//У тебя даже нет руды!
...
{
	IGetYouStill = "SVM_18_IGetYouStill";     //Моя достать тебя!
  DieEnemy = "SVM_18_DieEnemy";     //Морра зря приходить сюда!
  DieMonster = "SVM_18_DieMonster";     //Я убить тебя, вонючее отродье!
  DirtyThief = "SVM_18_DirtyThief";     //Морра вздумать воровать? Я наказать морра!
  HandsOff = "SVM_18_HandsOff";     //Морра убрать свои грязные руки!
  YouMurderer = "SVM_18_YouMurderer";     //Убийца!
  YouDareHitMe = "SVM_18_YouDareHitMe";     //Ты пожалеть об этом!
  YouAskedForIt = "SVM_18_YouAskedForIt";     //Я предупреждать тебя!
  ThenIBeatYouOutOfHere = "SVM_18_ThenIBeatYouOutOfHere";     //Моя говорить - морра убираться!
  WhatDidYouDoInThere = "SVM_18_WhatDidYouDoInThere";     //Что ты там делать?
  WillYouStopFighting = "SVM_18_WillYouStopFighting";     //Ты должен перестать делать это!
  KillEnemy = "SVM_18_KillEnemy";     //Грязный морра, я проучить тебя!
  EnemyKilled = "SVM_18_EnemyKilled";     //Вот тебе...
  Addon_MonsterKilled = "SVM_18_Addon_MonsterKilled";     //Еще одна победа во славу Великого Тарада!
  KillMurderer = "SVM_18_KillMurderer";     //Ты должен умирать, подлый убийца!
  StupidBeastKilled = "SVM_18_StupidBeastKilled";     //Глупая скотина!
  YouBetterShouldHaveListened = "SVM_18_YouBetterShouldHaveListened";     //Моя предупреждать тебя!
  GetUpAndBeGone = "SVM_18_GetUpAndBeGone";     //А теперь убираться!
  Alarm = "SVM_18_Alarm";     //ТРЕВОГА!
  Guards = "SVM_18_Guards";     //СТРАЖА! - убрать!
  GoodKill = "SVM_18_GoodKill";     //Да, показать этому грязному ублюдку!
  notnow = "SVM_18_NOTNOW";     //Морра оставить меня в покое!
  GetOutOfHere = "SVM_18_GetOutOfHere";     //Убираться отсюда!
  WhyAreYouInHere = "SVM_18_WhyAreYouInHere";     //Здесь нет места вонючим морра!
  YesGoOutOfHere = "SVM_18_YesGoOutOfHere";     //Да, морра, проваливать отсюда!
  WeaponDown = "SVM_18_WeaponDown";     //Я приказывать убирать оружие!
  ISaidWeaponDown = "SVM_18_ISaidWeaponDown";     //Убирать оружие, иначе я убить тебя!
  WiseMove = "SVM_18_WiseMove";     //А морра оказаться не такой тупой!
  CheerFriend01 = "SVM_18_CheerFriend01";     //Прикончи его!
  CheerFriend02 = "SVM_18_CheerFriend02";     //Продолжать! Я любить хорошая драка!
  CheerFriend03 = "SVM_18_CheerFriend03";     //Убивать его!
  GetOutOfMyBed = "SVM_18_GetOutOfMyBed";     //Морра не может спать на моем лежаке!
  toughguy_attacklost = "SVM_18_TOUGHGUY_ATTACKLOST";     //Морра оказаться сильнее. Чего ты хотеть?
  toughguy_attackwon = "SVM_18_TOUGHGUY_ATTACKWON";     //Теперь ты понимать, что со мной не стоит шутить. Чего ты хотеть?
  toughguy_playerattack = "SVM_18_TOUGHGUY_PLAYERATTACK";     //Ты опять приходить? Морра снова хотеть сражаться?
  Smalltalk01 = "SVM_18_Smalltalk01";     //Скоро мы захватить всю Миртану!
  Smalltalk02 = "SVM_18_Smalltalk02";     //я давно ожидать это
  Smalltalk03 = "SVM_18_Smalltalk03";     //моя слышать это от одного из шаман
  Smalltalk04 = "SVM_18_Smalltalk04";     //шаманы никогда не ошибаться
  Smalltalk05 = "SVM_18_Smalltalk05";     //Этот раб хотеть обмануть меня
  Smalltalk06 = "SVM_18_Smalltalk06";     //да, этим морра нельзя доверять
  Smalltalk07 = "SVM_18_Smalltalk07";     //мой топор разрубать мракориса одним ударом
  Smalltalk08 = "SVM_18_Smalltalk08";     //ты доказать это на арена
  Smalltalk09 = "SVM_18_Smalltalk09";     //Великий Тарад знает что делать
  Smalltalk10 = "SVM_18_Smalltalk10";     //я согласиться с тобой
  Smalltalk11 = "SVM_18_Smalltalk11";     //говорят, что его избрать сам Белиар
  Smalltalk12 = "SVM_18_Smalltalk12";     //я думать, что это правда
  Smalltalk13 = "SVM_18_Smalltalk13";     //ночью у лагеря я видеть нежить
  Smalltalk14 = "SVM_18_Smalltalk14";     //это нехорошее место
  Smalltalk15 = "SVM_18_Smalltalk15";     //скоро мы находить артефакты и уплывать отсюда
	Smalltalk16 = "SVM_18_Smalltalk16";     //Я хотеть сделать топор из руды
	Smalltalk17 = "SVM_18_Smalltalk17";     //Белиар слышать наши молитвы
	Smalltalk18 = "SVM_18_Smalltalk18";     //я надеяться на это
	Smalltalk19 = "SVM_18_Smalltalk19";     //Пираты совсем разлениться
	Smalltalk20 = "SVM_18_Smalltalk20";     //моя бы давно убить всех морра
	Smalltalk21 = "SVM_18_Smalltalk21";     //Я слышать, что в шахте опять беспорядки
	Smalltalk22 = "SVM_18_Smalltalk22";     //Ушак слишком жалеть этих грязных морра
	Smalltalk23 = "SVM_18_Smalltalk23";     //да, я согласиться с тобой
	Smalltalk24 = "SVM_18_Smalltalk24";     //говорят, что на острове есть паладины
	Smalltalk25 = "SVM_18_Smalltalk25";     //мы находить их и всех убить
	Smalltalk26 = "SVM_18_Smalltalk26";     //Пора подкрепиться
	Smalltalk27 = "SVM_18_Smalltalk27";     //я тоже так думать
	Smalltalk28 = "SVM_18_Smalltalk28";     //нужно сегодня еще потренироваться
	Smalltalk29 = "SVM_18_Smalltalk29";     //это никогда не помешать
	Smalltalk30 = "SVM_18_Smalltalk30";		//...Пакар справедливый орка...
	Smalltalk31 = "SVM_18_Smalltalk31";		//...Я знать об этом...
	Smalltalk32 = "SVM_18_Smalltalk32";		//...Из Аш-Кора мог бы получатся отличный шаман...
	Smalltalk33 = "SVM_18_Smalltalk33";		//...Моя не верить слухам...
	Smalltalk34 = "SVM_18_Smalltalk34";		//...Шаманы давно не выходить из храм...
	Smalltalk35 = "SVM_18_Smalltalk35";		//...Пак сделать отличный топор для меня...
	Smalltalk36 = "SVM_18_Smalltalk36";		//...Ушак уметь разбераться с глупый морра...
	Smalltalk37 = "SVM_18_Smalltalk37";		//...Я слышать, что на остров приплыть паладины...
	Smalltalk38 = "SVM_18_Smalltalk38";		//...Давно уже нужно убвать всех пиратов. Тарс зря с ними возиться...
	Smalltalk39 = "SVM_18_Smalltalk39";		//...Возможно ты быть прав...
	Smalltalk40 = "SVM_18_Smalltalk40";		//...Да, это то, что нужно...
	Smalltalk41 = "SVM_18_Smalltalk41";		//...Белиар нас защищать!...
	Smalltalk42 = "SVM_18_Smalltalk42";		//...Это никогда не помешать...
	Smalltalk43 = "SVM_18_Smalltalk43";		//...Аххх...
	Dead = "SVM_18_Dead";     //Аааааа!
  Aargh_1 = "SVM_18_Aargh_1";     //Аааааа
  Aargh_2 = "SVM_18_Aargh_2";     //Аааааа
  Aargh_3 = "SVM_18_Aargh_3";     //Аааааа
  
  	gold_1000 = "SVM_18_GOLD_1000";	//1000 золотых монет.
	gold_950 = "SVM_18_GOLD_950";	//950 золотых монет.
	gold_900 = "SVM_18_GOLD_900";	//900 золотых монет.
	gold_850 = "SVM_18_GOLD_850";	//850 золотых монет.
	gold_800 = "SVM_18_GOLD_800";	//800 золотых монет.
	gold_750 = "SVM_18_GOLD_750";	//750 золотых монет.
	gold_700 = "SVM_18_GOLD_700";	//700 золотых монет.
	gold_650 = "SVM_18_GOLD_650";	//650 золотых монет.
	gold_600 = "SVM_18_GOLD_600";	//600 золотых монет.
	gold_550 = "SVM_18_GOLD_550";	//550 золотых монет.
	gold_500 = "SVM_18_GOLD_500";	//500 золотых монет.
	gold_450 = "SVM_18_GOLD_450";	//450 золотых монет.
	gold_400 = "SVM_18_GOLD_400";	//400 золотых монет.
	gold_350 = "SVM_18_GOLD_350";	//350 золотых монет.
	gold_300 = "SVM_18_GOLD_300";	//300 золотых монет.
	gold_250 = "SVM_18_GOLD_250";	//250 золотых монет.
	gold_200 = "SVM_18_GOLD_200";	//200 золотых монет.
	gold_150 = "SVM_18_GOLD_150";	//150 золотых монет.
	gold_100 = "SVM_18_GOLD_100";	//100 золотых монет.
	gold_90 = "SVM_18_GOLD_90";	//90 золотых монет.
	gold_80 = "SVM_18_GOLD_80";	//80 золотых монет.
	gold_70 = "SVM_18_GOLD_70";	//70 золотых монет.
	gold_60 = "SVM_18_GOLD_60";	//60 золотых монет.
	gold_50 = "SVM_18_GOLD_50";	//50 золотых монет.
	gold_40 = "SVM_18_GOLD_40";	//40 золотых монет.
	gold_30 = "SVM_18_GOLD_30";	//30 золотых монет.
	gold_20 = "SVM_18_GOLD_20";	//20 золотых монет.
	gold_10 = "SVM_18_GOLD_10";	//10 золотых монет.

	sheepkiller_crime = "SVM_18_StupidBeastKilled";     //Глупая скотина!
	attack_crime = "SVM_18_WhyAreYouInHere";     //Здесь нет места вонючим морра!
	theft_crime = "SVM_18_YesGoOutOfHere";     //Да, морра, проваливать отсюда!
