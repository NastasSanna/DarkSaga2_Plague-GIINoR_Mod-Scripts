...
const string MOBNAME_OBV_BLACK_SWORD = "Черный Клинок";
const string MOBNAME_PUGALO = "Пугало";
...
const string MOBNAME_CHAIR = "Кресло";
...
const string MOBNAME_ORE = "Жила магической руды";
...
const string MOBNAME_DP_BAR = "Таверна";
...
const string MOVER_NAME_KOLODA = "Бревна";
const string MOBNAME_ORCDRUM = "Там-Там";
const string MOBNAME_ORCBIGDRUM = "Барабаны";
const string MOBNAME_FORT_OB = "Доска";
const string MOBNAME_SILVEROREHACKEN = "Жила серебряной руды";
const string MOBNAME_IRONOREHACKEN = "Жила железной руды";
const string MOBNAME_MONETFIRE = "Плавильня";
const string MOBNAME_MONETANVIL = "Станок для чеканки";
const string MOBNAME_WOOD = "Дерево";
const string MOBNAME_PALM = "Пальма";
const string MOBNAME_PIT = "Магический колодец";
const string MOBNAME_DARAGON_TELEPORT = "Древний постамент";
const string MOBNAME_PRAYDARK = "Темный алтарь";
const string MOBNAME_GRAVE = "Могила";
const string MOBNAME_GRAVE_SAGATEAM_DROM = "Мое имя написано на воде. DRom";
const string MOBNAME_GRAVE_SAGATEAM_REDLEHA = "Redleha - ”Welcome to Russia-Samara-Nsk!”";
const string MOBNAME_GRAVE_SAGATEAM_DRUID = "Druid - ””";
const string MOBNAME_GRAVE_SAGATEAM_SKIF = "Skif - ””";
const string MOBNAME_GRAVE_EXZARCIST = "Exzarcist, я не забыл о своем обещании!";
const string MOBNAME_GRAVE_JOWOOD = "JoWooD, покойся с миром!";
const string MOBNAME_FOX_DEAD = "Лис";
const string MOBNAME_DS_SKINTABLE = "Скорняжный стол";
const string MOBNAME_BAR_HUNT = "Райский ковчег";
const string MOBNAME_HUNTER_GATE = "Постучать";
const string MOBNAME_CHEST_HEW = "Сундук Хью";
const string MOBNAME_GRAVE_MORTIS_TEAM_SATURAS = "Saturas - ...здесь меня больше нет, я легче чем воздух и свет...";
//********* DSG Prolog **********
...
const string NAME_SPL_SummonIceWolf = "Вызов ледяного волка";
...
const string NAME_SPL_WindBolt = "Воздушный болт";
const string NAME_SPL_Telekinesis = "Телекинез";
const string NAME_SPL_SoulTravel  = "Путешествие души";
...
const string TXT_TALENTS_SKILLS[22] =
{
	...
	"Новичок|Стрелок|Мастер",
	"-|Изучено",
	"Новичок|Опытный рудокоп|Настоящий рудокоп|Хороший рудокоп|Великий рудокоп|Гуру рудокопов",
	"0|1|2|3|4|5|6",
	"-|Изучено",
	"-|Изучено",
	"-|Боец|Мастер",
	"-|Изучено",
	"-|Новичок|Умелец|Мастер",
	"-|Изучено",
	"-|Изучено",
	"-|Изучено",
	"-                           / -|-                           / Изучено|Изучено            / -      |Изучено            / Изучено",
	"-                           / -|Язык крестьян / -      |Язык знати       / -      |Язык жрецов    / -      |-                          / Изучено|Язык крестьян / Изучено|Язык знати       / Изучено|Язык жрецов    / Изучено",
	"-|Изучено",
...
const string NAME_DS_DRAWING = "Чертеж";
const string NAME_DS_DRAWING_BOW = "Чертеж лука";
const string NAME_DS_DRAWING_CBOW = "Чертеж арбалета";
const string NAME_DS_DRAWING_SWD = "Чертеж меча";
const string NAME_DS_DRAWING_AXE = "Чертеж топора";
...
const string NAME_Addon_BeArMC = "Вместе с доспехами из брони ползунов +";
const string NAME_Addon_BeArLeather = "Вместе с кожаными доспехами +";
const string NAME_DS_BeArPIR = "Вместе с доспехами пирата +";
...
const string NAME_ManaPerSec = "Расход маны в секунду:";
...
const string NAME_DS_StrAndDex_needed = "Необходима сила и ловкость:";
const string NAME_TalentShield_needed = "Необходим навык владения щитом";
const string NAME_TalentOrcWeapon_needed = "Необходим навык владения орочьим оружием";
const string NAME_Talent2x2_needed = "Необходим навык владения двумя клинками";
...
const string NAME_DS_Prot_EdgeAndPoint = "Защита от оружия и стрел:";
const string NAME_DS_Prot_EdgeAndPointAndFire = "Защита от оружия, стрел и огня:";
const string NAME_DS_Prot_EdgeAndPointAndMagicAndFire = "Защита от оружия, стрел, магии и огня:";
...
const string NAME_Bonus_Mana_DS = "Прибавка к мане (в %) :";
...
const string NAME_DS_Bonus_StrAndDex = "Прибавка к силе и ловкости:";
const string NAME_DS_Bonus_MW_HitChance = "Прибавка к навыкам владения оружием ближнего боя:";
const string NAME_DS_Bonus_RW_HitChance = "Прибавка к навыкам владения оружием дальнего боя:";
const string NAME_DS_AntiBonus_Dex = "Штраф к ловкости:";
const string NAME_DS_AntiBonus_Str = "Штраф к силе:";
...
const string NAME_ADDON_WISPSKILL_BONUSARMOR01 = "Увеличение защиты первого уровня";
const string NAME_ADDON_WISPSKILL_BONUSARMOR02 = "Увеличение защиты второго уровня";
const string NAME_ADDON_WISPSKILL_BONUSARMOR03 = "Увеличение защиты третьего уровня";
const string NAME_ADDON_WISPSKILL_BONUSATTACK01 = "Атака огонька первого уровня";
const string NAME_ADDON_WISPSKILL_BONUSATTACK02 = "Атака огонька второго уровня";
const string NAME_ADDON_WISPSKILL_BONUSATTACK03 = "Атака огонька третьего уровня";
const string NAME_ADDON_WISPSKILL_MANAREGENERATION = "Регенерация маны";
const string NAME_ADDON_WISPSKILL_HPREGENERATION = "Регенерация жизни";
const string NAME_ADDON_WISPSKILL_LIGHTWISP = "Светящийся огонек";
const string NAME_ADDON_WISPSKILL_FINDING = "Поиск скрытых тайников";
...
const string NAME_ADDON_BONUS_BOW = "Меткость стрельбы из лука +";
const string NAME_ADDON_BONUS_CROSSBOW = "Меткость стрельбы из арбалета +";
...
const string PRINT_DS_THISAIRCORRODESMYLUNGS = "Этот воздух разъедает мои легкие";
const string PRINT_DS_MYHEALTHHASIMPAIRED = "Мое здоровье ухудшилось";
const string PRINT_DS_LEARNHITPOINTS_MAX = "Здоровье: - ";
const string PRINT_DS_Learn2X2Weapon_Level_1 = "Изучен: 1-й уровень владения двумя клинками";
const string PRINT_DS_Learn2X2Weapon_Level_2 = "Изучен: 2-й уровень владения двумя клинками";
const string PRINT_DS_LearnOrcWeapon_Level_1 = "Изучен: 1-й уровень владения орочьим оружием";
const string PRINT_DS_LearnOrcWeapon_Level_2 = "Изучен: 2-й уровень владения орочьим оружием";
const string PRINT_DS_LearnShield_Level_1 = "Изучен: 1-й уровень владения щитом";
const string PRINT_DS_LearnShield_Level_2 = "Изучен: 2-й уровень владения щитом";
const string PRINT_DS_LearnProtectionEDGE 	= "Улучшено: Защита от оружия";
const string PRINT_DS_LearnProtectionPOINT 	= "Улучшено: Защита от стрел";
const string PRINT_DS_LearnProtectionFIRE 	= "Улучшено: Защита от огня";
const string PRINT_DS_LearnProtectionMAGIC 	= "Улучшено: Защита от магии";
const string PRINT_DS_GoldGiven = "Золото отдано: ";
const string PRINT_DS_GoldTaken = "Золото получено: ";
const string PRINT_DS_GoldShtuk = " монет";
const string PRINT_DS_Item_1_Give = "Предмет отдан: ";
const string PRINT_DS_Item_Lot_Give = "Предметы отданы: ";
const string PRINT_DS_Item_1_Take = "Предмет получен: ";
const string PRINT_DS_Item_Lot_Take = "Предметы получены: ";
const string PRINT_DS_BOOKGEGEBEN = " книга отдана:";
const string PRINT_DS_BOOKSGEGEBEN = " книг отдано:";
const string PRINT_DS_Shtuk = " шт.";

const string PRINT_GoldGegeben = " золота отдано";
const string PRINT_ItemGegeben_1 = " предмет отдан ";
const string PRINT_ItemGegeben_234 = " предмета отдано ";
...
const string PRINT_LearnPickpocket_2 = "Обчистить карманы стало легче";
const string PRINT_LearnPickpocket_3 = "Обчистить карманы стало еще легче";
const string PRINT_Beliarshitpoints_MAX = "Здоровье -";
const string PRINT_LearnSmith = "Изучено: Искусство изготовления оружия";
const string PRINT_DS_LEARNFUSING = "Изучено: Искусство плавки";
...
const string PRINT_DS_LearnTakeAnimalTrophy = "Изучено: Добыча трофеев животных";
const string PRINT_DS_LearnTrophySkin = "Изучено: Обработка трофеев животных";
...
const string PRINT_WISPISNOTFORUSING = "Я не могу использовать огонек сегодня.";
...
const string PRINT_LEARNSTR2 = "Сила +2";
const string PRINT_LearnSTR5 = "Сила +5";
const string PRINT_LearnDEX1 = "Ловкость +1";
const string PRINT_LEARNDEX2 = "Ловкость +2";
const string PRINT_LearnDEX5 = "Ловкость +5";
const string PRINT_LearnMANA1 = "Мана +1";
const string PRINT_LearnMANA5 = "Мана +5";
const string PRINT_LearnHITPOINTS10 = "Макс.жизнь +10";
const string PRINT_LearnHITPOINTS20 = "Макс.жизнь +20";
const string PRINT_LearnHITPOINTS50 = "Макс.жизнь +50";
...
const string PRINT_LearnPickOre2 = "Рудное дело +2";
const string PRINT_LearnPickOre10 = "Рудное дело +10";
const string PRINT_LearnPickPocket1 = "Основы воровства";
const string PRINT_LearnPickPocket2 = "Продвинутое воровство";
const string PRINT_LearnPickPocket3 = "Профессиональное воровство";
const string PRINT_LearnOrcWeapon1 = "Орочье оружие (1-й уровень)";
const string PRINT_LearnOrcWeapon2 = "Орочье оружие (2-й уровень)";
const string PRINT_Learn2x2H1 = "Обучи меня владению двумя клинками (1-й уровень)";
const string PRINT_Learn2x2H2 = "Обучи меня владению двумя клинками (2-й уровень)";
...
const string PRINT_DS_ArrowSuccess = "Стрела готова!";
const string PRINT_DS_ArrowsSuccess = "Стрелы готовы!";
const string PRINT_DS_BoltSuccess = "Болт готов!";
const string PRINT_DS_BoltsSuccess = "Болты готовы!";
const string PRINT_DS_SkinSuccess = "Шкура обработана!";
const string PRINT_DS_SkinsSuccess = "Шкуры обработаны!";
const string PRINT_DS_ArmorSuccess = "Броня готова!";
const string PRINT_DS_ArmorGoodSuccess = "Броня укреплена!";
const string PRINT_DS_FusingGoldSuccess = "Золотой самородок расплавлен!";
const string PRINT_DS_FusingGoldAllSuccess = "Золотые самородки расплавлены!";
const string PRINT_DS_FusingSilverSuccess = "Кусок серебряной руды расплавлен!";
const string PRINT_DS_FusingSilverAllSuccess = "Самородки серебряной руды расплавлены!";
const string PRINT_DS_FusingMagicOreSuccess = "Кусок магической руды расплавлен!";
const string PRINT_DS_FusingMagicOreAllSuccess = "Самородки магической руды расплавлены!";
const string PRINT_DS_FusingSpellBoundOreSuccess = "Получен сплав из магической и серебряной руд!";
const string PRINT_DS_FusingSpellBoundOreAllSuccess = "Получен сплав из магической и серебряной руд!";
const string PRINT_DS_FusingBlackOreSuccess = "Кусок черной руды расплавлен!";
const string PRINT_DS_FusingBlackOreAllSuccess = "Самородки черной руды расплавлены!";
const string PRINT_DS_FusingIronOreSuccess = "Кусок железной руды расплавлен!";
const string PRINT_DS_FusingIronOreAllSuccess = "Самородки железной руды расплавлены!";

const string PRINT_DS_CoiningGoldSuccess = "Получено: 1 золотая монета!";
const string PRINT_DS_CoiningGold10Success = "Получено: 10 золотых монет!";
//const string PRINT_DS_CoiningGoldAllSuccess = "Золотые самородки расплавлены!";
const string PRINT_DS_CoiningSilverSuccess = "Кусок серебряной руды расплавлен!";
const string PRINT_DS_CoiningSilverAllSuccess = "Самородки серебряной руды расплавлены!";
const string PRINT_DS_CoiningMagicOreSuccess = "Кусок магической руды расплавлен!";
const string PRINT_DS_CoiningMagicOreAllSuccess = "Самородки магической руды расплавлены!";
const string PRINT_DS_CoiningIronOreSuccess = "Кусок железной руды расплавлен!";
const string PRINT_DS_CoiningIronOreAllSuccess = "Самородки железной руды расплавлены!";
const string PRINT_DS_StormPosohSuccess = "Посох собран!";
...
const string PRINT_ALCHEMYSUCCESSWISP = "Рудный амулет огонька заряжен энергией!";
const string PRINT_DS_FUSINGGOLDMELTSUCCESS = "Золотой расплав получен!";
const string PRINT_DS_NoTalentFusing = "Я не умею плавить самородки!";
//NS - 26/10/13
const string PRINT_CoiningItemsTemplatesMissing = "Нет штампов для чеканки!";
const string PRINT_CoiningItemsMonetsMissing = "Нет заготовок для чеканки!";
const string PRINT_CoiningItemsTemplatesAndMonetsMissing = "Эти заготовки не подходят к штампам!";
const string PRINT_Made_Result = "Изготовлено:";
const string PRINT_MadeFrom_Gold = "из золота";
const string PRINT_MadeFrom_Silver = " из серебра";
const string PRINT_MadeFrom_Iron = " из стали";
const string PRINT_MadeFrom_MagicOre = "из магической руды";
const string PRINT_MadeFrom_BlackOre = " из черной руды";
const string PRINT_MadeFrom_SpellBoundOre = " из сплава серебра и магической руды";
//*/
//const string PRINT_CoiningItemsTemplatesMissing = "У меня нет ни одной формы для чеканки!";
//const string PRINT_CoiningItemsMonetsMissing = "У меня нет ни одной заготовки для чеканки!";
//const string PRINT_CoiningItemsTemplatesAndMonetsMissing = "Нет ни одного соответствия формы и заготовки!";
const string PRINT_DS_WoodRawItemsMissing = "У меня нет древесины!";
const string PRINT_DS_ArrowRaw_ArrowSuccess = "Древки для стрел изготовлены!";
const string PRINT_DS_ArrowRaw_BoltSuccess = "Древки для болтов изготовлены!";
const string PRINT_ProdItemsMissing = "Недостаточно ингредиентов!";
const string PRINT_ProdSmithItemsMissing = "Недостаточно компонентов!";
...
const string PRINT_DS_NewLogEntry = "Запись в дневнике: ”";
const string PRINT_TeleportTooFarAway = "Слишком далеко";

const int YPOS_GoldGiven = 30;
const int YPOS_GoldTaken = 30;
const int YPOS_DS_Gold = 30;
const int YPOS_ItemGiven = 34;
const int YPOS_ItemTaken = 37;
const int YPOS_LOGENTRY = 45;
const int YPOS_LevelUp = 54;
const int YPOS_XPGained = 58;
...
const string PRINT_SHIELDTALENT_MISSING = "Необходим навык владения щитом";
...
const string PRINT_DS_FRENSISARMOR_MISSING = "Эти доспехи нельзя использовать";
...
const string PRINT_TALENT_2x2H_MISSING = "Необходим навык владения двумя клинками";

const string NAME_2X2HANDED = "Оружие для использования во второй руке.";
//---------Напитки--------------------------------------
const string TXT_DS_POTIONS_0 = "Лечебная эссенция";
const string TXT_DS_POTIONS_1 = "Лечебный экстракт";
const string TXT_DS_POTIONS_2 = "Лечебный эликсир";
const string TXT_DS_POTIONS_3 = "Эссенция маны";
const string TXT_DS_POTIONS_4 = "Экстракт маны";
const string TXT_DS_POTIONS_5 = "Эликсир маны";
const string TXT_DS_POTIONS_6 = "Зелье ускорения";
const string TXT_DS_POTIONS_7 = "Эликсир силы";
const string TXT_DS_POTIONS_8 = "Эликсир ловкости";
const string TXT_DS_POTIONS_9 = "Эликсир духа";
const string TXT_DS_POTIONS_10 = "Эликсир жизни";
const string TXT_DS_POTIONS_11 = "Зелье из драконьих яиц";
const string TXT_DS_POTIONS_12 = "Зарядить амулет Инноса";
const string TXT_DS_POTIONS_13 = "Чистая мана";
const string TXT_DS_POTIONS_14 = "Чистая жизнь";
const string TXT_DS_POTIONS_15 = "Зарядить амулет ищущего огонька";
//---------Трофеи--------------------------------------
const string TXT_DS_TROPHYS_0 = "Вырезать клыки";
const string TXT_DS_TROPHYS_1 = "Вырезать когти";
const string TXT_DS_TROPHYS_2 = "Снимать шкуры с животных";
const string TXT_DS_TROPHYS_3 = "Вынимать сердца магических существ";
const string TXT_DS_TROPHYS_4 = "Вырезать рог мракориса";
const string TXT_DS_TROPHYS_5 = "Вырезать язык огенных ящеров";
const string TXT_DS_TROPHYS_6 = "Отрезать крылья кровавых мух";
const string TXT_DS_TROPHYS_7 = "Вырезать жало кровавых мух";
const string TXT_DS_TROPHYS_8 = "Вырезать жвала животных";
const string TXT_DS_TROPHYS_9 = "Снимать панцири ползунов";
const string TXT_DS_TROPHYS_10 = "Вырезать рог драконьего снеппера";
const string TXT_DS_TROPHYS_11 = "";
const string TXT_DS_TROPHYS_12 = "Сцеживать кровь";
const string TXT_DS_TROPHYS_13 = "Сдирать шкуры с рептилий";

const string TXT_DS_POTIONS[MAX_POTION] =
{
	"Лечебная эссенция",
	"Лечебный экстракт",
	"Лечебный эликсир",
	...
	"Эликсир духа",
	"Эликсир жизни",
	"Зелье из драконьих яиц",
	"Зарядить амулет Инноса",
	"Чистая мана",
	"Чистая жизнь",
	"Зарядить амулет ищущего огонька",
	// новые
	"Настойка воина",
	"Особая настойка воина",
	"Настойка охотника",
	"Особая настойка охотника",
	"Настойка Ботье",
	"Настойка могущества",
	"Зарядить артефакт Хаоса"
};
const string TXT_DS_TROPHYS[MAX_TROPHIES] =
{
	"Вырезать клыки",
	"Вырезать когти",
	"Снимать шкуры с животных",
	"Вынимать сердца магических существ",
	"Вырезать рог мракориса",
	"Вырезать язык огенных ящеров",
	"Отрезать крылья кровавых мух",
	"Вырезать жало кровавых мух",
	"Вырезать жвала животных",
	"Снимать панцири ползунов",
	"Вырезать рог драконьего снеппера",
	"",
	"",
	"Сдирать шкуры с рептилий"
};
//Еще строчные константы для перевода
const string PRINT_BadEffect_BlackStone_GoAway = "Зловещая сила Черного камня уходит.";
const string PRINT_BadEffect_BlackStone_DexDown = "Камень понизил твою ловкость.";
const string PRINT_BadEffect_BlackStone_StrDown = "Камень ослабляет тебя.";
const string PRINT_BadEffect_BlackStone_FightDown = "Камень иссушает тебя";
const string PRINT_GoodEffect_GreenStone_DexUp = "Камень увеличил твою ловкость.";
const string PRINT_GoodEffect_GreenStone_DexDown = "Сила камня иссякла.";
const string PRINT_GoodEffect_GreenStone_SpeedUp = "Камень дает тебе скорость.";
const string PRINT_GoodEffect_GreenStone_DamageUp = "Камень поможет тебе в бою...";
const string PRINT_GoodEffect_GreenStone_DamageDown = "Чары возвращаются в камень...";
const string PRINT_GoodEffect_WellChar_ProtUp = "Чары магического колодца защищают тебя.";
const string PRINT_GoodEffect_WellChar_ProtDown = "Защита магического колодца ослабла.";
const string PRINT_DS_GhoulGlass_IsFull = "Кровь сполна заполнила склянку!";
const string PRINT_DS_NOTHINGTOGET_THERE = "Здесь больше нечего делать.";
const string PRINT_GiveSword = "Получен клинок";
const string PRINT_NotCast_TryAgain = "Не получилось... Надо попробовать еще раз";
const string Name_OrcMagicStonePlate = "Оркская каменная табличка";
const string Name_MagicKeyToSanctuary = "Один из ключей к Святилищу";
const string Text_ITKE_STRANGEKEY_1 = "Необычный фрагмент камня, сделан в виде статуэтки.";
const string Text_ITKE_STRANGEKEY_2 = "На нем видны небольшие углубления.";
const string Text_ITKE_STRANGEKEY_3 = "Видимо, он используется как ключ.";
const string Name_Bonus_RegenHP = "Бонус: Восстановление здоровья.";
const string Name_Bonus_RegenMana = "Бонус: Регенерация маны.";
const string NAME_DS_Bonus_AtrAll = "Бонус ко всем параметрам";
const string Name_DS_ReadyToCoining = "Готова для чеканки";
const string Name_DS_SmithForm = "Кузнечная форма";
const string Text_InThisFish = "В этой рыбе что-то спрятано.";
const string Name_DS_SkinBag = "Кожаный мешочек";
const string Text_RuneIsNeededShrine = "Руну нужно благословить";
const string Print_ItSeemsImNoticed = "Кажется, меня заметили!";
const string Print_OccursNothing = "Ничего не происходит.";
const string Print_ItSeemsIveFoundSmth = "Кажется, я кое-что нашел...";
const string Name_LeatherPurse = "Кожаный кошелек";

//DarkSaga
const string KapWechsel_DSG_1 = "Глава 1";
const string KapWechsel_DSG_1_Text = "ПРОЛОГ";
const string KapWechsel_DSG_2 = "Глава 2";
const string KapWechsel_DSG_2_Text = "";
const string KapWechsel_DSG_3 = "Глава 3";
const string KapWechsel_DSG_3_Text = "";
//DSG
const string PRINT_DSG_LearnSTR_Plus = "Сила: +";
const string PRINT_DSG_LearnDEX_Plus = "Ловкость: +";
const string PRINT_DSG_LearnHPMax_Plus = "Максимум здоровья: +";
const string PRINT_DSG_LearnSTR_Minus = "Сила: -";
const string PRINT_DSG_LearnDEX_Minus = "Ловкость: -";
const string PRINT_DSG_LearnHPMax_Minus = "Максимум здоровья: -";
//DSG: Алхимия
const string PRINT_SKL_Alchemy = "Навык алхимика: ";
const string PRINT_SKL_Alchemy_Check = "(проверить навык алхимика)";
const string PRINT_SKL_Alchemy_Up = "Повышен навык алхимика: +";
const string PRINT_AlchemyFlaskBroken = "Мензурка разбилась.";
const string PRINT_AlchemyFail = "Ничего не вышло...";
const string PRINT_AlchemySuccess_1 = "Получено зелье низкого качества.";
const string PRINT_AlchemySuccess_2 = "Получено зелье среднего качества.";
const string PRINT_AlchemySuccess_3 = "Получено зелье высокого качества.";

//DSG: Артефакты Хаоса
const string TXT_Chaos_AtrBounus[ATR_INDEX_MAX] = {
	"Здоровье: +",
	"Жизненная сила: +",
	"Уровень маны: +",
	"Максимальная манв: +",
...
const string TXT_Chaos_AtrAntiBounus[ATR_INDEX_MAX] = {
	"Здоровье: ",
	"Жизненная сила: ",
	"Уровень маны: ",
	"Максимальная манв: ",
...
const string TXT_Chaos_TalBounus[4] = {
	"Владение одноручным оружием: +",
	"Владение двуручным оружием: +",
	"Владение луком: +",
	"Владение арбалетом: +"
};
const string TXT_Chaos_TalAntiBounus[4] = {
	"Владение одноручным оружием: ",
	"Владение двуручным оружием: ",
	"Владение луком: ",
	"Владение арбалетом: "
};
const string TXT_Chaos_ProtBounus[3] = {
	"Защита от оружия: +",
	"Защита от стрел: +",
	"Защита от магии: +"
};
const string TXT_Chaos_ProtAntiBounus[3] = {
	"Защита от оружия: ",
	"Защита от стрел: ",
	"Защита от магии: "
};
