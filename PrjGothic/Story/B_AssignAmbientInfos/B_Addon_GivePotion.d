...
func int DIA_Addon_GivePotion_Condition()
{
	if((self.aivar[AIV_PARTYMEMBER] == TRUE) && (self.flags != NPC_FLAG_IMMORTAL)
		&& (self.guild < GIL_SEPERATOR_HUM))	//NS - только дл€ людей! прочим свои диалоги, иначе могут зависнуть на анимации
	{
...
{
	AI_Output(other,self,"DIA_Addon_Brandon_GivePotion_15_00");	//¬от, возьми это лечебное зелье.
