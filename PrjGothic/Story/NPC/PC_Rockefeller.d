...
instance PC_Rockefeller(Npc_Default)
{
	...
	CreateInvItem(self,ITAR_PIR_L_DS);
	CreateInvItem(self,ITAR_PIR_M_DS);
	...
	CreateInvItems(self,ItPl_SwampHerb,50);
	CreateInvItems(self,ItPl_Mana_Herb_01,50);
	CreateInvItems(self,ItPl_Mana_Herb_02,50);
	CreateInvItems(self,ItPl_Mana_Herb_03,50);
	CreateInvItems(self,ItPl_Health_Herb_01,50);
	CreateInvItems(self,ItPl_Health_Herb_02,50);
	CreateInvItems(self,ItPl_Health_Herb_03,50);
	CreateInvItems(self,ItPl_Dex_Herb_01,50);
	CreateInvItems(self,ItPl_Strength_Herb_01,50);
	CreateInvItems(self,ItPl_Speed_Herb_01,50);
	CreateInvItems(self,ItPl_Mushroom_01,50);
	CreateInvItems(self,ItPl_Mushroom_02,50);
	CreateInvItems(self,ItPl_Forestberry,50);
	CreateInvItems(self,ItPl_Blueplant,50);
	CreateInvItems(self,ItPl_Planeberry,50);
	CreateInvItems(self,ItPl_Temp_Herb,50);
	CreateInvItems(self,ItPl_Perm_Herb,50);
	...
	CreateInvItems(self,ItRw_Bolt_01,1000);
	...
	CreateInvItems(self,ItPo_Mana_01,100);
	CreateInvItems(self,ItPo_Mana_02,100);
	CreateInvItems(self,ItPo_Mana_03,100);
	CreateInvItems(self,ItPo_Mana_Addon_04,100);
	CreateInvItems(self,ItPo_Health_01,100);
	CreateInvItems(self,ItPo_Health_02,100);
	CreateInvItems(self,ItPo_Health_03,100);
	CreateInvItems(self,ItPo_Health_Addon_04,100);
	CreateInvItems(self,ItPo_Perm_STR,100);
	CreateInvItems(self,ItPo_Perm_DEX,100);
	CreateInvItems(self,ItPo_Perm_Health,100);
	CreateInvItems(self,ItPo_Perm_Mana,100);
	CreateInvItems(self,ItPo_Speed,100);
