...
func void B_AssessMurder()
{
	...
	if(((weapondamage + enemydexterity) - victim.protection[PROT_POINT]) >= 0)
	{
		weaponfulldamage = (weapondamage + enemydexterity) - victim.protection[PROT_POINT];
	}
	else
	{
		weaponfulldamage = 0;
	...
	if(((enemystrength + weapondamage) - self.protection[PROT_FIRE]) >= 0)
	{
		strengthfire = (enemystrength + weapondamage) - self.protection[PROT_FIRE];
	}
	else
	{
		strengthfire = 0;
