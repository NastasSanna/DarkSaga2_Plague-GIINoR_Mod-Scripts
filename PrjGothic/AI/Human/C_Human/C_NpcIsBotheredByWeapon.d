...
func int C_NpcIsBotheredByWeapon(var C_Npc slf,var C_Npc oth)
{
	...
	//*NS - 09/07/2013 вблизи мишени можно стрелять, только не в меня
	If (Npc_IsInFightMode(oth,FMODE_FAR) && (!Npc_IsAiming(oth,slf))
		&& (C_DSG_NpcIsOnTrainingGround_Ranged(oth)))
	{
		return FALSE;
	};
	//*/
