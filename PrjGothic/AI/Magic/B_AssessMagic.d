...
func void B_AssessMagic()
{
	...
	MEM_Debug(ConcatStrings("B_AssessMagic self = ",slf._zCObject_objectName));
...
/*
// **********големы*********
	if((Npc_GetLastHitSpellID(self) == SPL_Icelance) && (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(SfireGolem)))
//(self.guild == GIL_FIREGOLEM)
	{
			Npc_ChangeAttribute(self,ATR_HITPOINTS,-100);
		Npc_ChangeAttribute(other,ATR_HITPOINTS,-100);
			return;
	};
*/
};
