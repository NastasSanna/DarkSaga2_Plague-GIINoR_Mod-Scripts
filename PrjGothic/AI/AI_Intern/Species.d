...
instance Gil_Values(C_GILVALUES)
{
	...
	fight_range_base[GIL_SWAMPSHARK] = 90;		//было 200
	fight_range_fist[GIL_SWAMPSHARK] = 90;		//было 200
	fight_range_g[GIL_SWAMPSHARK] = 90;			//было 200
	...
	swim_time[GIL_DS_PIRANHA] = TIME_INFINITE;
	dive_time[GIL_DS_PIRANHA] = TIME_INFINITE;
	water_depth_knee[GIL_DS_PIRANHA] = 999999;
	water_depth_chest[GIL_DS_PIRANHA] = 999999;
	step_height[GIL_DS_PIRANHA] = 100;
	jumplow_height[GIL_DS_PIRANHA] = 800;
	slide_angle[GIL_DS_PIRANHA] = 50;
	disable_autoroll[GIL_DS_PIRANHA] = 0;
	surface_align[GIL_DS_PIRANHA] = 0;
	turn_speed[GIL_DS_PIRANHA] = 240;
	falldown_height[GIL_DS_PIRANHA] = 9999;
	falldown_damage[GIL_DS_PIRANHA] = 0;
	fight_range_base[GIL_DS_PIRANHA] = 80;
	fight_range_fist[GIL_DS_PIRANHA] = 80;
	fight_range_g[GIL_DS_PIRANHA] = 100;
	
	swim_time[GIL_DS_RABBIT] = TIME_INFINITE;
	dive_time[GIL_DS_RABBIT] = 0;
	water_depth_knee[GIL_DS_RABBIT] = 25;
	water_depth_chest[GIL_DS_RABBIT] = 50;
	jumplow_height[GIL_DS_RABBIT] = 105;
	jumpmid_height[GIL_DS_RABBIT] = 200;
	slide_angle[GIL_DS_RABBIT] = 50;
	disable_autoroll[GIL_DS_RABBIT] = 1;
	surface_align[GIL_DS_RABBIT] = 1;
	turn_speed[GIL_DS_RABBIT] = 120;
	falldown_height[GIL_DS_RABBIT] = 400;
	falldown_damage[GIL_DS_RABBIT] = 10;
	fight_range_base[GIL_DS_RABBIT] = 130;
	fight_range_fist[GIL_DS_RABBIT] = 95;
	fight_range_g[GIL_DS_RABBIT] = 95;
	blood_emitter[GIL_DS_RABBIT] = "BFX_Preset1";
	blood_texture[GIL_DS_RABBIT] = "BQM_Scavenger2.tga";
	blood_amount[GIL_DS_RABBIT] = 10;
	blood_max_distance[GIL_DS_RABBIT] = 100;
	
	//NS (10/02/2014)
	swim_time[GIL_Keiler] = TIME_INFINITE;
	dive_time[GIL_Keiler] = 0;
	water_depth_knee[GIL_Keiler] = 40;
	water_depth_chest[GIL_Keiler] = 70;
	step_height[GIL_Keiler] = 60;
	jumplow_height[GIL_Keiler] = 100;
	jumpmid_height[GIL_Keiler] = 200;
...
/*/NS выходит за пределы массива
	swim_time[GIL_DSG_LARVA] = 0;
	dive_time[GIL_DSG_LARVA] = 0;
	water_depth_knee[GIL_DSG_LARVA] = 10;
	water_depth_chest[GIL_DSG_LARVA] = 15;
	slide_angle[GIL_DSG_LARVA] = 50;
	disable_autoroll[GIL_DSG_LARVA] = 1;
	surface_align[GIL_DSG_LARVA] = 2;
	turn_speed[GIL_DSG_LARVA] = 240;
	falldown_height[GIL_DSG_LARVA] = 1000;
	falldown_damage[GIL_DSG_LARVA] = 1;
	fight_range_base[GIL_DSG_LARVA] = 30;
	fight_range_fist[GIL_DSG_LARVA] = 40;
	fight_range_g[GIL_DSG_LARVA] = 40;
//*/
};
