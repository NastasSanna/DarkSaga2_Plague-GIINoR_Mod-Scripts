...
//	};
	...
	else if(Wld_IsTime(self.aivar[AIV_MM_SleepStart],0,self.aivar[AIV_MM_SleepEnd],0) || (self.aivar[AIV_MM_SleepStart] == OnlyRoutine))
	{
	...
	else if(Wld_IsTime(self.aivar[AIV_MM_OrcSitStart],0,self.aivar[AIV_MM_OrcSitEnd],0) || (self.aivar[AIV_MM_OrcSitStart] == OnlyRoutine))
	{
		...
		{
			AI_StartState(self,ZS_MM_Rtn_Sit,1,"");
		}
		else
		{
