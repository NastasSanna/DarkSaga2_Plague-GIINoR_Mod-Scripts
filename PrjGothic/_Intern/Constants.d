...
const string FONT_Screen_HI = "FONT_OLD_20_WHITE_HI.TGA";
const string FONT_ScreenSmall = "FONT_OLD_10_WHITE.TGA";
const string FONT_ScreenSmall_HI = "FONT_OLD_10_WHITE_HI.TGA";
...
//NS: рукописные и книжный
const string FONT_DSG_Handwrite_Small = "Font_DSG_Handwrite_16.TGA";
const string FONT_DSG_Handwrite_Medium = "Font_DSG_Handwrite_20.TGA";
const string FONT_DSG_Handwrite_Big = "Font_DSG_Handwrite_22.TGA";
const string FONT_DSG_Book = "Font_DSG_Book_14.TGA";
const string FONT_DSG_BookHeadline = "Font_DSG_Book_22.TGA";

//---------------------------------------------------------------------------------
//Saturas : по защите проекта
const int ICP = 0;
var int TestPassed;
var int UserName_IsPidor;
var int Pidor_Counter;
//Saturas: константы для Ext'а
//Константы объектов игры
const int zCObject_const 				= 0; 	//Базовый объект(не используется!)
const int zCVob_const						= 1; 	//Виртуальный объект мира (деревья, и прочие статичные объекты) - ok
const int oCVob_const 					= 2; 	//Расширенный класс виртуального объекта (пока не используется)
const int oCMob_const 					= 3; 	//Базовый класс интерактивных объектов - ok
const int oCMobInter_const 			= 4; 	//Класс интерактивного объекта (алхимический стол и т.д.) - ok
const int oCMobBed_const				= 5; 	//Объект типа "Кровать"
const int oCMobFire_const				= 6; 	//Объект типа "Фонарь/факел"(как в Г1, которые еще зажигать можно)
const int oCMobItemSlot_const 	= 7; 	//Объект со слотом для предмета
const int oCMobLadder_const			= 8; 	//Объект типа "Лестница"
const int oCMobLockable_const 	= 9; 	//Закрывающийся на ключ объект.
const int oCMobContainer_const 	= 10;	//Контейнер (может быть заперт на ключ) - ok
const int oCMobDoor_const				= 11;	//Дверь (может быть заперта на ключ)
const int oCMobSwitch_const			= 12;	//Переключатель
const int oCMobWheel_const			= 13;	//???
const int oCTriggerScript_const	= 14;	//Триггер скрипт. - ok
//----------------------------------------------------------------------------------
...
const float TRADE_VALUE_MULTIPLIER = 0.10;
...
const int SPL_DSP_TeleportForestTower = 8;
const int SPL_DSP_TeleportFortTower = 9;
const int SPL_DSP_TeleportCampTower = 10;
...
const int SPL_WindBolt = 90;
const int SPL_Telekinesis = 91;
const int SPL_SoulTravel  = 92;
...
const int NPC_TALENT_PICKORE = 6;
...
const int NPC_TALENT_SHIELD = 9;		//Навык владение щитом
const int NPC_TALENT_2X2H = 10;			//Навык двуручное оружие
...
const int NPC_DS_SKIN = 17;
const int NPC_TALENT_WISPDETECTOR = 18;
const int NPC_TALENT_C = 19;
const int NPC_TALENT_FUSING = 20;
const int NPC_TALENT_ORCWEAPON = 21;	//Навык - Орочье оружие
const int NPC_TALENT_MAX = 22;
const int NPC_DS_PROTECTION = 23;
const int NPC_TALENT_FOREIGNLANGUAGE 		= 24;

var int player_talent_runes[MAX_SPELL];
const int LANGUAGE_1 = 0;
const int LANGUAGE_2 = 1;
const int LANGUAGE_3 = 2;
const int ORC_LANGUAGE_1 = 3;
const int ORC_LANGUAGE_2 = 4;
const int ORC_LANGUAGE_3 = 5;
const int MAX_LANGUAGE = 6;
var int player_talent_foreignlanguage[6];
//по Саге - орочье оружие, щиты, воровство, два клинка
const int WEAPON_2X2_LEVEL_NONE = 0;
const int WEAPON_2X2_LEVEL_FIRST = 1;
const int WEAPON_2X2_LEVEL_SECOND = 2;
const int WEAPON_2X2_LEVEL_THIRD = 3;
const int MAX_WEAPON_2X2_LEVEL = 4;
var int player_talent_2x2weapon[MAX_WEAPON_2X2_LEVEL];
//Орочье оружие
const int ORCWEAPON_LEVEL_NONE = 0;
const int ORCWEAPON_LEVEL_FIRST = 1;
const int ORCWEAPON_LEVEL_SECOND = 2;
const int MAX_ORCWEAPON_LEVEL = 3;
var int player_talent_orcweapon[MAX_ORCWEAPON_LEVEL];
//Щит
const int SHIELD_LEVEL_NONE = 0;
const int SHIELD_LEVEL_FIRST = 1;
const int SHIELD_LEVEL_SECOND = 2;
const int MAX_SHIELD_LEVEL = 3;
var int player_talent_SHIELD[MAX_SHIELD_LEVEL];
//Воровство карманов
const int PICKPOCKET_LEVEL_NONE = 0;
const int PICKPOCKET_LEVEL_FIRST = 1;
const int PICKPOCKET_LEVEL_SECOND = 2;
const int PICKPOCKET_LEVEL_THIRD = 3;
const int MAX_PICKPOCKET_LEVEL = 4;
var int player_talent_PICKPOCKET[MAX_PICKPOCKET_LEVEL];
//
...
const int WISPSKILL_BONUSARMOR01 = 7;
const int WISPSKILL_BONUSARMOR02 = 8;
const int WISPSKILL_BONUSARMOR03 = 9;
const int WISPSKILL_BONUSATTACK01 = 10;
const int WISPSKILL_BONUSATTACK02 = 11;
const int WISPSKILL_BONUSATTACK03 = 12;
const int WISPSKILL_MANAREGENERATION = 13;
const int WISPSKILL_HPREGENERATION = 14;
const int WISPSKILL_LIGHTWISP = 15;
const int WISPSKILL_FINDING = 16;
const int MAX_WISPSKILL = 17;
var int player_talent_wispdetector[17];
...
//напитки-Алхимия
//* NS - 31/01/2013
// типы зелий (направления алихимии)
const int ALCHEMY_Essence	= 0;	// выпаривание
const int ALCHEMY_Extract	= 1;	// вытяжка
const int ALCHEMY_Elixir	= 2;	// перегонка
const int ALCHEMY_Perm		= 3;	// обработка царского щавеля
const int ALCHEMY_Time		= 4;	// выжимка
const int MAX_ALCHEMY	= 5;
var int PLAYER_TALENT_ALCHEMY_BASICS[MAX_ALCHEMY];
// знание рецептов
...
const int CHARGE_WISP			= 15;
// новые
const int POTION_DSG_TinkturStr_wenig		= 16;
const int POTION_DSG_TinkturStr_besondere	= 17;
const int POTION_DSG_TinkturDex_wenig		= 18;
const int POTION_DSG_TinkturDex_besondere	= 19;
const int POTION_DSG_TinkturBotje_wenig		= 20;
const int POTION_DSG_TinkturBotje_besondere	= 21;
const int CHARGE_DSG_ChaosArtefacts			= 22;
const int MAX_POTION		= 23;
...
//***************************ds************
const int WEAPON_ThornWood = 13;
const int WEAPON_OreDagger = 14;
const int WEAPON_WolfT = 15;
const int WEAPON_BloodFlow = 16;
const int WEAPON_HowlBlood = 17;
const int WEAPON_2h_Star = 18;
const int WEAPON_Conquer = 19;
const int WEAPON_2h_Reveng = 20;
const int WEAPON_2h_Crusher = 21;
const int WEAPON_OrcSlay = 22;
const int WEAPON_PiratSword = 23;
const int WEAPON_MasterSword = 24;
const int WEAPON_DeathSong = 25;
const int WEAPON_WavCut = 26;
const int WEAPON_UndeadSlay = 27;
const int WEAPON_2H_Punch =28;
const int WEAPON_2H_Urrok = 29;
const int WEAPON_2H_Agash = 30;
const int WEAPON_2H_Brokdar = 31;
const int WEAPON_2H_RageOrc = 32;
const int WEAPON_2H_OkoBeliar = 33;
const int WEAPON_2H_OreConq = 34;
...
//Выделка кожи
const int SKIN_COMMON 		= 0;
const int SKIN_DO_LIGHT 	= 1;
const int SKIN_REDO_LIGHT 	= 2;
const int SKIN_DO_MEDIUM 	= 3;
const int SKIN_REDO_MEDIUM 	= 4;
const int SKIN_DO_HARD 		= 5;
const int SKIN_REDO_HARD 	= 6;
const int SKIN_DO_TROLL 	= 7;
const int SKIN_REDO_TROLL 	= 8;
const int MAX_SKINS = 9;
var int player_talent_skin[MAX_SKINS];
//Плавка
const int FUSING_GOLD = 0;
const int FUSING_MAGICORE = 1;
const int FUSING_SILVERORE = 2;
const int FUSING_IRONORE = 3;
const int FUSING_BLACKORE = 4;
var int player_talent_fusing[6];
...
const int INVCAM_ENTF_MISC6_STANDARD = 4500;
const int INVCAM_X_RING_STANDARD = 25;
const int INVCAM_Z_RING_STANDARD = 45;

const int OPENMIS = 1;
const int CLOSEMIS = 2;

//Redleha: наше

func void xxxxxxxxxxxxxxxxxxxxx()
{	
};
func void yyyyyyyyyyyyyyyyyyyyy()
{
};
func void iiiiiiiiiiiiiiiiiiiii()
{
};
func void B_STOP_DECOMPILATION_CRASH_L()
{
...
const int NEWWORLD_ZEN = 30;
const int OldWorld_Zen = 31;
//Redleha: Уровень сложности
var int ComplexityLevel;
const int Light = 1;
const int Medium = 2;
const int Hard = 3;
var int ComplexityLevel_Procent;
const int Light_LL = -40;
const int Light_L = -20;
const int Hard_H = 20;
const int Hard_HH = 40;

const int Less = 0;
const int More = 1;
//Множитель цен для свитков
const int Sc_DS_Kosten = 2; 